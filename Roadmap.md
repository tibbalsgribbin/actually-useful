...
**Current bundles:**
- Phase 4 + Phase 5 → one bundle (panel chrome + settings page)
...
6. Updated **Project_Briefing.md** — PART TWO (volatile state) always; PART ONE (stable core) only if something in it actually changed
7. Updated **Roadmap.md** — check phase boxes, update next-session priorities, update known-issues list
