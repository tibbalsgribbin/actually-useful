...
*Current version: v0.6.1.78 (overall) · v0.6.1 (manifest) · v0.6.1.78 (search.js) · v0.6.1.53 (core.js) · compare.html updated Chat 61 · v0.6.1.17 (background.js)*
*Updated May 12, 2026 (Chat 63 — multi-pack × weight PPU, isServingWeight, hyphenated oz fix)*
...
- **Overall / canonical version:** v0.6.1.78 (search.js number — the main file)
- **Per-file versions:** search.js v0.6.1.78 · core.js v0.6.1.53 · compare.html updated Chat 61 · background.js v0.6.1.17 · manifest v0.6.1 · styles.css updated Chat 60 · welcome.html created Chat 59
...
- `content/search.js` — v0.6.1.78 — main content script; all scraping, PPU, panel UI
...
## 18. Multi-pack × weight PPU — architecture summary (Chat 63)
