...
| `compare.html` | Actually Useful Comparisons page |
| `index.html` | Landing page |
| `privacy.html` | Privacy policy |
| `data/brand_blocklist.txt` | Website copy — fetched by compare.html. Must match extension/data/ copy. |
| `data/amazon_brands.txt` | Website copy — fetched by compare.html. Must match extension/data/ copy. |
...
**UI (search.js panel, as of v0.6.1.62):**
...
**compare.html filter logic:** Uses `item.freeDateTs || item.fastDateTs` (epoch ms). Same exemption and threshold logic.
...
**Table columns (all toggleable):** checkbox, thumbnail, product, price, per unit, delivery, rating, reviews, Prime, coupon/promo, source, brand, notes.
