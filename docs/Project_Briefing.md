...
*Current version: v0.6.1.27 (overall) · v0.6.1 (manifest) · v0.6.1.27 (search.js) · v0.6.1.17 (compare.html) · Updated April 25, 2026 (Chat 32)*
...
- Filter bar: keyword, min reviews, min rating, min/max price, source/retailer, hide sponsored
...
- Paid delivery fields available in payload from v0.6.1.27 forward (compare.html display update pending)
...
- **styles.css** — `.ppu-delivery.paid { color: #b45309; }` not yet added (next session)
- **compare.html** — paid delivery + window range not yet displayed (payload ready, display pending)
