...
## Current version: v0.6.2.0 (overall) · v0.6.1 (manifest) · v0.6.2.0 (search.js) · v0.6.1.53 (core.js) · v0.6.1.18 (background.js) · styles.css updated Chat 78 · welcome.html rewritten Chat 75 · welcome-bridge.js new Chat 75 · compare.html updated Chat 66 · index.html updated Chat 66 · privacy.html updated Chat 66
...
- **"Always hide" semantics** — popover label says "Always hide" but implementation demotes to bottom at 50% opacity. Pre-existing UX question, not a Phase 7A bug. Track for a future UX session.
- **Bug reporting on cards without detected brand** — no ⋯ menu and footer link now fills this gap (any card is reportable). But reporting a brand-less card sends null brand — verify Supabase accepts this gracefully.
...
- Phase 7 bundle (7A extension + 7B website) → 7A complete (Chats 76–78); 7B next
...
**Phase 7B — Sonnet coding session, website only.** Kickoff brief: `Phase7B_Kickoff_Brief_Chat76.md`. Review it before the session — check if any Phase 7A decisions affect 7B scope.

Before opening the Phase 7B session:
1. Push Phase 7A code (search.js + styles.css) to GitHub
2. Update Claude Project documents (Handover, Changelog, Roadmap, Briefing)
3. Upload the website files fresh from GitHub
4. Paste the Phase 7B kickoff brief
...
- [ ] **Phase 7B — Website polish** (Sonnet — next)
...
- [ ] Welcome page copy review (all SUGGESTED COPY blocks — including new report banner)
- [ ] r/vibecodedevs post
- [ ] Facebook post
...
- [ ] Supabase `bug_reports` table — Melissa creates before testing Phase 7A bug reporting
...
- [ ] Bug reporting tool live (Phase 7A) ✅ — but needs Supabase table creation + copy review
